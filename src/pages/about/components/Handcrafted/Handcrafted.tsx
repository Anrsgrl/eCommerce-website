  ...
  return (
    <div className="Handcrafted-field">
      <div className="Handcrafted-container">
        <div id="image1">
          <img
            src="https://casona.familab.net/wp-content/uploads/2021/08/blog-1.jpg"
            alt="img1"
            width="1400"
          />
        </div>
        <div id="text1">
          ...
          <p>
            Casona is a contemporary lifestyle platform connecting artists, designers, influencers and
            customers in a personalised and content-rich environment. Meets our strict criteria of quality
            materials, craftsmanship and originality.
          </p>
        </div>
        <div id="text2">
          <Link to="/about">
